  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <h1 className="text-4xl font-bold font-display mb-4 text-foreground">Privacy Policy</h1>
        ...
        <div className="space-y-8 max-w-none">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-foreground">3. AI Processing & Third-Party Processors</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-foreground">5. Your User Rights (GDPR & CCPA/CPRA)</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-foreground">6. Data Retention and Security</h2>
            <p className="text-muted-foreground leading-relaxed">
