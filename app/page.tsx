...
export default function LandingPage() {
  ...
  const features = [
    ...
    { icon: TrendingUp, title: "Real-Time SEO Scoring", desc: "Built-in content grader surfaces quick wins. See exactly which tweaks push you to page one." },
        ...
        <div className="min-h-screen bg-background aurora-bg noise-overlay overflow-x-hidden selection:bg-[var(--gold)]/20 selection:text-[var(--gold)] relative">
          ...
          <section className="max-w-6xl mx-auto px-4 sm:px-6 pt-8 sm:pt-12 md:pt-16 pb-8 sm:pb-12 md:pb-16 text-center relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-2.5 mb-6 sm:mb-8 animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-300">
              <Link href="/auth/signup" className="btn-gold group w-full sm:w-auto px-5 sm:px-6 py-2.5 sm:py-3 text-xs md:text-sm flex items-center justify-center gap-2 relative overflow-hidden shadow-xl shadow-[var(--gold)]/20 touch-manipulation">
          ...
          <section ref={statsRef} className="border-y border-border/40 bg-secondary/10 backdrop-blur-md relative z-10">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-8 grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              <StatCard value={12000} suffix="+" label="Articles Published" started={statsInView} />
              <StatCard value={98} suffix="%" label="Customer Satisfaction" started={statsInView} />
              <StatCard value={3} suffix="×" label="Avg. Traffic Increase" started={statsInView} />
              <StatCard value={2} suffix="min" label="Avg. Draft Time" started={statsInView} />
            </div>
          </section>
          ...
          <section className="max-w-6xl mx-auto px-4 sm:px-6 py-10 sm:py-14 md:py-16">
            <div className="text-center">
              <div className="inline-flex items-center gap-2 rounded-full border border-border/60 px-3 py-1.5 mb-6 bg-background/50 backdrop-blur-sm">
                <CheckCircle2 className="w-3 h-3 text-[var(--teal)]" />
                <span className="text-[0.6rem] font-bold text-[var(--text-3)] tracking-[0.15em] uppercase">Trusted Platform</span>
              </div>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-black font-display text-[var(--text-1)] tracking-tight mb-6 sm:mb-8">
                Built for <span className="gradient-gold-teal">Content Teams</span>
              </h2>
              ...
              <div className="flex flex-wrap items-center justify-center gap-x-6 sm:gap-x-8 gap-y-3 sm:gap-y-4">
                <div className="flex items-center gap-1.5">
                  <CheckCircle2 className="w-3 h-3 text-[var(--teal)]" />
                  <span className="text-[10px] sm:text-xs font-bold text-[var(--text-3)]">500+ Active Users</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <CheckCircle2 className="w-3 h-3 text-[var(--teal)]" />
                  <span className="text-[10px] sm:text-xs font-bold text-[var(--text-3)]">12,000+ Articles Published</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <CheckCircle2 className="w-3 h-3 text-[var(--teal)]" />
                  <span className="text-[10px] sm:text-xs font-bold text-[var(--text-3)]">98% Satisfaction Rate</span>
                </div>
              </div>
            </div>
          </section>
              ...
              <div className="max-w-6xl mx-auto">
                <PricingCards
                  ...
                  onSelectPlan={(plan, isAnnual) => {
                    if (plan === 'free') window.location.href = '/auth/signup';
                  }}
                />
              </div>
            </div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-xs sm:text-sm md:text-base text-[var(--text-2)] mb-6 leading-relaxed max-w-xl mx-auto">
                  Stop wrestling with AI prompts and manual formatting. Join 500+ teams using Pubwize to dominate the SERPs with ease.
                </p>
