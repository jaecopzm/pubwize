...
export function OnboardingChecklist({ totalArticles, totalSites, hasWordPress }: OnboardingChecklistProps) {
  ...
  return (
    <div className="card-premium rounded-xl lg:rounded-2xl border border-gold/30 bg-gradient-to-br from-gold/5 to-transparent p-3 sm:p-4 lg:p-6 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-start justify-between mb-3 sm:mb-4 gap-2">
          <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
            <div className="flex h-8 w-8 sm:h-10 sm:w-10 items-center justify-center rounded-lg sm:rounded-xl bg-gold text-obsidian shrink-0">
              ...
              >
                <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className={cn(
                      ...
                      step.completed ? "text-teal" : "text-foreground"
                    )}>
                      {step.title}
                    </p>
                ...
                {!step.completed && (
                  <button
                    ...
                    className="px-2.5 py-1.5 sm:px-3 text-[10px] sm:text-xs font-semibold rounded-lg bg-gold text-obsidian hover:bg-gold/90 transition-colors whitespace-nowrap shrink-0"
                  >
                    {step.action}
                  </button>
                )}
